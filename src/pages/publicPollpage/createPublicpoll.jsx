...
class CreatePublicPoll extends Component {
    state = { 
        options:[""],
        poll_done:false,
        empty_option:true,
    ...
    render() { 
        if(this.state.poll_done){
            return (
                <Redirect to={{pathname:"/dashboard/publicpoll", state:{token:this.props.location.state.token}}} />
            );
        }
        return ( 
...
export default CreatePublicPoll;